...
public class AppSettings {
            ...
            @Override public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        //                        AppSelect.getAppSelect().set(activity, appSettingsVP);
                        return true;
                }
                return false;
            }
     ...
     * @param appSettingsVP
     */
    private void downloadBtn(final ViewGroup appSettingsVP) {
        final ViewGroup cbtn = (ViewGroup) activity.findViewById(R.id.app_settings_download_map);
        cbtn.setOnTouchListener(new View.OnTouchListener() {
            @Override public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                    ...
                    case MotionEvent.ACTION_UP:
                        cbtn.setBackgroundColor(activity.getResources().getColor(R.color.my_icons));
                        //                        AppDownload.getAppDownload().set(activity, appSettingsVP);
                        return true;
                }
                return false;
            }
