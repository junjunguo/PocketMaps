 ...
 */
public class MyMapView extends ViewGroup implements org.mapsforge.map.view.MapView{
    ...
    public MyMapView(Context context, AttributeSet attributeSet) {
        ...
        TouchGestureDetector touchGestureDetector = new MyTouchGestureDetector(this, viewConfiguration);
